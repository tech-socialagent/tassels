...
function Menu() {
  ...
  const accessories = ['a','ac','acc','acce','acces','access','accesso','accessor','accessori','accessorie','accessories']
  ...
  const handleInputChange = (event) => {
    ...
    else if (product !== 'Accessories' && accessories.includes(searched.toLowerCase())) {
