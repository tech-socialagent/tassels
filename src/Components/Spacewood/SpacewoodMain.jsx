...
function SpacewoodMain() {
    const data = [
        ...
        },
        {
            ...
            img: ['/Assets/spacewood/wardrobes1.webp',
                '/Assets/spacewood/wardrobes2.webp',
                '/Assets/spacewood/wardrobes3.webp',]
        },
        {
            title: 'BEDROOM SET',
            ...
            img: ['/Assets/spacewood/room1.webp',
                '/Assets/spacewood/room2.webp',
                '/Assets/spacewood/room3.webp',]
        },
    ]
